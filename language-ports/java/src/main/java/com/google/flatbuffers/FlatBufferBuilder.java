...
public class FlatBufferBuilder {
    ...
    /** Where we construct the FlatBuffer.*/
    ByteBuffer bb;
    ...
    /** Factory for allocating the internal buffer*/
    ByteBufferFactory bb_factory;
    /** UTF-8 encoder to use*/
    final Utf8 utf8;
   ...
   */
    ...
    * <li>`Monster#endMonster(FlatBufferBuilder)` will ensure {@link #endTable()} is called.</li>
    * </ul>
    * <p>
    * Calling this method directly is not recommended. If it's called manually, you must ensure
